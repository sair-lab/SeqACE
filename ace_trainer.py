    ...
    def create_training_buffer(self):
        ...
        with torch.no_grad():
            ...
            while buffer_idx < self.options.training_buffer_size:
                dataset_passes += 1
                for image_B1HW, image_mask_B1HW, gt_pose_B44, gt_pose_inv_B44, intrinsics_B33, intrinsics_inv_B33, _, file_path, _,idx, _, track_info, keypoint_mask in training_dataloader:
