...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for image_B1HW, _, gt_pose_B44, _, intrinsics_B33, _, _, filenames,global_feat,idx, gray_images in testset_loader:
            ...
            with autocast(enabled=True):
                if opt.test_mode > 0:
                    scene_coordinates_B3HW, scores = network.get_scene_coordinates_and_points(image_B1HW, global_feat)
                    scores = scores.float()
