...
class CamLocDataset(Dataset):
    ...
    def _get_single_item(self, idx, image_height):
        ...
        if self.load_kpts:
            return image, image_mask, pose, pose_inv, intrinsics, intrinsics_inv, coords, str(self.rgb_files[idx]), global_feat, idx, original_image, padded_keypoints, keypoint_mask
        else:
            return image, image_mask, pose, pose_inv, intrinsics, intrinsics_inv, coords, str(self.rgb_files[idx]), global_feat, idx, original_image
